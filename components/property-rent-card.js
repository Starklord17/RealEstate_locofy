...
const PropertyRentCard = ({ propBackgroundImage }) => {
  ...
  return (
    <div
      className="flex-1 rounded-md h-[426px] flex flex-col p-6 box-border items-center justify-end bg-[url(/card-11@3x.png)] bg-cover bg-no-repeat bg-[top] min-w-[355px] max-w-[370px] text-left text-base text-gray-white font-body-regular-500"
      style={card1Style}
    >
